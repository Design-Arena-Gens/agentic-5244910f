    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">IndustryCom</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href={`/${currentLocale}`} className="text-gray-400 hover:text-white transition-colors">
                  {tNav('home')}
                </Link>
              </li>
              <li>
                <Link href={`/${currentLocale}/products`} className="text-gray-400 hover:text-white transition-colors">
                  {tNav('products')}
                </Link>
              </li>
              <li>
                <Link href={`/${currentLocale}/about`} className="text-gray-400 hover:text-white transition-colors">
                  {tNav('about')}
                </Link>
              </li>
              <li>
